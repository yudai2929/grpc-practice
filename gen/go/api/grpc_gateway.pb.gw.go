...
func RegisterGateWayServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GateWayServiceServer) error {
	...
	mux.Handle("POST", pattern_GateWayService_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/your.service.v1.GateWayService/Echo", runtime.WithHTTPPathPattern("/v1/example/echo"))
		if err != nil {
...
func RegisterGateWayServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GateWayServiceClient) error {
	...
	mux.Handle("POST", pattern_GateWayService_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/your.service.v1.GateWayService/Echo", runtime.WithHTTPPathPattern("/v1/example/echo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
