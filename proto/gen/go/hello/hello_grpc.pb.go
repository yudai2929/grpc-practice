...
const (
	GreetingService_Hello_FullMethodName             = "/proto.hello.GreetingService/Hello"
	GreetingService_HelloServerStream_FullMethodName = "/proto.hello.GreetingService/HelloServerStream"
	GreetingService_HelloClientStream_FullMethodName = "/proto.hello.GreetingService/HelloClientStream"
	GreetingService_HelloBiStreams_FullMethodName    = "/proto.hello.GreetingService/HelloBiStreams"
)
...
var GreetingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.hello.GreetingService",
